export const SAMPLE_REPORT = {
  ...
  use_case: {
    ...
    chatgpt_enterprise_role:
      "Drafting structured recaps and action plans that are then edited before sending.",
    outcome_positive: [
  ...
  ratings: {
    ...
    notes:
      "Self-reported weekly time savings: about 2-5 hours depending on follow-ups and QBRs.",
  },
  ...
  key_quotes: [
    {
      when: "00:01:25",
      quote:
        "Yesterday after a customer check-in, I needed to turn the discussion into a crisp follow-up with recap, risks, and next steps.",
      topic: "Use case",
    },
    {
      when: "00:02:05",
    ...
    quotes: [
      {
        when: "turn 2",
        quote:
          "I'm a Customer Success Manager. Most of my week is customer calls, adoption planning, QBR prep, and follow-ups.",
        topic: "Role context",
      },
      {
        when: "turn 8",
      ...
      },
      {
        when: "turn 10",
        quote:
          "Mainly standard chat, but I used Canvas to polish the email and action-plan formatting.",
        topic: "Tools used",
      },
      {
        when: "00:02:30",
  ...
  quality: {
    ...
    ambiguity_notes: [
      "Sensitive contract and pricing details are intentionally kept out of prompts.",
    ],
  },
};
